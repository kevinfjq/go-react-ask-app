    ...
    <div className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-4">
      ...
      <form className="flex items-center gap-2 bg-zinc-900 p-2 rounded-xl border border-zinc-800 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-1">
        <input
          ...
          autoComplete="off"
          className="flex-1 text-sm bg-transparent mx-2 outline-none text-zinc-100 placelholder:text-zinc-500"
        />
      ...
      <ol className="list-decimal list-outside px-3 space-y-8">
        <li className="ml-4 leading-relaxed text-zinc-100">
          o que é Golang e quais suas principais vantagens em comparação com outras linguagens de programção como
          Python, Java ou C++?
